    ...
    <section className="grid grid-cols-1 md:grid-cols-2 gap-6">
      ...
      <div className="md:col-span-2 p-6 sm:p-8 rounded-2xl relative overflow-hidden flex flex-col justify-center min-h-[200px] sm:min-h-[220px] bg-gradient-to-br from-secondary-500 to-primary-500">
        ...
        <div className="relative z-10 max-w-full">
          <h4 className="text-2xl font-bold mb-2 text-white font-headline">
            Insights da Clínica
          </h4>
          <p className="leading-relaxed text-white/90 font-body">
          ...
          <button className="mt-6 px-6 py-2 rounded-lg text-sm transition-transform active:scale-95 shadow-xl bg-surface text-primary-500 font-bold hover:bg-surface-hover hover:text-primary-600 border border-border-subtle">
