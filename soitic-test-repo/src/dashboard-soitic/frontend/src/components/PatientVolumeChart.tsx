...
function CustomTooltip({ active, payload, label }: any) {
  ...
  return (
    <div className="editorial-shadow rounded-xl px-4 py-3 bg-surface border border-border-subtle font-body">
...
export function PatientVolumeChart({ weeklyData, monthlyData }: Props) {
  ...
  const chartData = (view === "week" ? weeklyData : monthlyData).map(
    (d, i) => ({
      name:
        view === "week"
  ...
  return (
    <div className="editorial-shadow rounded-xl p-8 h-full bg-surface border border-border-subtle transition-colors duration-300">
      <div className="flex items-start justify-between mb-6">
        ...
        {/* Toggle */}
        <div className="flex rounded-lg p-1 gap-1 bg-surface-hover border border-border-subtle transition-colors">
        ...
        >
          <defs>
            <linearGradient id="primaryGrad" x1="0" y1="0" x2="0" y2="1">
              <stop
                offset="5%"
                stopColor="var(--color-primary-500, #5E00FF)"
                stopOpacity={0.25}
              />
              <stop
                offset="95%"
          ...
          <XAxis
            ...
            tick={{
              ...
              fill: "var(--color-text-secondary, #2A2F45)",
              fontWeight: 600,
              letterSpacing: 0.5,
            }}
            axisLine={false}
          ...
          <Area
            ...
            dot={{
              r: 4,
              fill: "var(--color-primary-500, #5E00FF)",
              strokeWidth: 0,
            }}
            activeDot={{
              r: 6,
